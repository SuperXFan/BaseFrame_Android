...
public class PieChartView extends View {
     ...
     * 饼图中心区域
     */
    private RectF pieChartCircleCenterRectF = new RectF();
    ...
    private void drawAllSectors(Canvas canvas) {
        ...
        drawCenterSector(canvas, Color.parseColor("#FFFFFF"), 0, 360);
    }
    ...
    private void initpieChartCircleCenterRectF() {
        pieChartCircleCenterRectF.left = pieChartCircleRectF.left + pieChartCircleRadius / 2;
        pieChartCircleCenterRectF.top = pieChartCircleRectF.top + pieChartCircleRadius / 2;
        pieChartCircleCenterRectF.right = pieChartCircleRectF.right  - pieChartCircleRadius / 2 ;
        pieChartCircleCenterRectF.bottom = pieChartCircleRectF.bottom - pieChartCircleRadius / 2;
    }
    /**
    ...
    protected void drawSector(Canvas canvas, int color, float startAngle, float sweepAngle) {
        ...
        canvas.drawArc(pieChartCircleRectF, startAngle, sweepAngle-1, true, paint);

    }

    protected void drawCenterSector(Canvas canvas, int color, float startAngle, float sweepAngle) {
        ...
        canvas.drawArc(pieChartCircleCenterRectF, startAngle, sweepAngle, true, paint);
