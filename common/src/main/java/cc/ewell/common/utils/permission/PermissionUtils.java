package cc.ewell.common.utils.permission;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(BaseUtil.getApplication().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(BaseUtil.getApplication(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + BaseUtil.getApplication().getPackageName()));
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(BaseUtil.getApplication());
    }
