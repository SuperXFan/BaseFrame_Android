...
public final class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final BaseUtil.OnAppStatusChangedListener listener) {
        BaseUtil.getActivityLifecycle().addListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        BaseUtil.getActivityLifecycle().removeListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        BaseUtil.getApplication().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        BaseUtil.getApplication().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        return !isSpace(packageName)
                && BaseUtil.getApplication().getPackageManager().getLaunchIntentForPackage(packageName) != null;
    }
    ...
    public static boolean isAppInstalled(@NonNull final String action,
        ...
        PackageManager pm = BaseUtil.getApplication().getPackageManager();
    ...
    public static boolean isAppDebug() {
        return isAppDebug(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return BaseUtil.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        BaseUtil.getApplication().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp() {
        PackageManager packageManager = BaseUtil.getApplication().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(BaseUtil.getApplication().getPackageName());
        if (intent == null) return;
        ComponentName componentName = intent.getComponent();
        Intent mainIntent = Intent.makeRestartActivityTask(componentName);
        BaseUtil.getApplication().startActivity(mainIntent);
        System.exit(0);
    }
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        BaseUtil.getApplication().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = BaseUtil.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return BaseUtil.getApplication().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(BaseUtil.getApplication().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = BaseUtil.getApplication().getPackageName() + ".utilcode.provider";
            data = FileProvider.getUriForFile(BaseUtil.getApplication(), authority, file);
        }
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = BaseUtil.getApplication().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) BaseUtil.getApplication().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(BaseUtil.getApplication().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) BaseUtil.getApplication().getSystemService(Context.APP_OPS_SERVICE);
                if (aom != null) {
                    if (aom.checkOpNoThrow(AppOpsManager.OPSTR_GET_USAGE_STATS,
                            info.uid,
                            info.packageName) != AppOpsManager.MODE_ALLOWED) {
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        BaseUtil.getApplication().startActivity(intent);
                    }
                    if (aom.checkOpNoThrow(AppOpsManager.OPSTR_GET_USAGE_STATS,
                            info.uid,
                            info.packageName) != AppOpsManager.MODE_ALLOWED) {
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) BaseUtil.getApplication()
