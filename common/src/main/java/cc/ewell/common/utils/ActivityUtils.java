...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(BaseUtil.getApplication().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(BaseUtil.getApplication().getPackageManager()) == null ||
                BaseUtil.getApplication().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = BaseUtil.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(BaseUtil.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(BaseUtil.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(BaseUtil.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(BaseUtil.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Intent intent) {
        startActivity(intent, BaseUtil.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivity(@NonNull final Intent intent,
                                     @NonNull final Bundle options) {
        startActivity(intent, BaseUtil.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, BaseUtil.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, BaseUtil.getTopActivityOrApp(), options);
    }
    ...
    public static List<Activity> getActivityList() {
        return BaseUtil.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(BaseUtil.getApplication().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return BaseUtil.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = BaseUtil.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(BaseUtil.getApplication(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(BaseUtil.getApplication(), clz));
    }
